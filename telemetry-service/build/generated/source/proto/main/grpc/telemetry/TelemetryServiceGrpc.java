...
public final class TelemetryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<telemetry.TelemetryRequest,
      telemetry.TelemetryResponse> getStreamTelemetryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "streamTelemetry",
      requestType = telemetry.TelemetryRequest.class,
      responseType = telemetry.TelemetryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<telemetry.TelemetryRequest,
      telemetry.TelemetryResponse> getStreamTelemetryMethod() {
    io.grpc.MethodDescriptor<telemetry.TelemetryRequest, telemetry.TelemetryResponse> getStreamTelemetryMethod;
      ...
      synchronized (TelemetryServiceGrpc.class) {
        if ((getStreamTelemetryMethod = TelemetryServiceGrpc.getStreamTelemetryMethod) == null) {
          TelemetryServiceGrpc.getStreamTelemetryMethod = getStreamTelemetryMethod =
              io.grpc.MethodDescriptor.<telemetry.TelemetryRequest, telemetry.TelemetryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "streamTelemetry"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  telemetry.TelemetryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  telemetry.TelemetryResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void streamTelemetry(telemetry.TelemetryRequest request,
        io.grpc.stub.StreamObserver<telemetry.TelemetryResponse> responseObserver) {
  ...
  public static final class TelemetryServiceStub
    ...
    /**
     */
    public void streamTelemetry(telemetry.TelemetryRequest request,
        io.grpc.stub.StreamObserver<telemetry.TelemetryResponse> responseObserver) {
  ...
  public static final class TelemetryServiceBlockingStub
    ...
    /**
     */
    public java.util.Iterator<telemetry.TelemetryResponse> streamTelemetry(
        telemetry.TelemetryRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_STREAM_TELEMETRY:
          serviceImpl.streamTelemetry((telemetry.TelemetryRequest) request,
              (io.grpc.stub.StreamObserver<telemetry.TelemetryResponse>) responseObserver);
          break;
        default:
