...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, SatelliteEvent> consumerFactory() {
        ...
        JsonDeserializer<SatelliteEvent> valueDeserializer = new JsonDeserializer<>(SatelliteEvent.class);
        valueDeserializer.addTrustedPackages("telemetry.dto", "satellite.dto");
